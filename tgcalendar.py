...
def create_calendar(lang,year=None,month=None):
    ...
    row=[]
    row.append(InlineKeyboardButton(texts.get_month_name(month,lang)+" "+str(year),callback_data=data_ignore))
    keyboard.append(row)
    #Second row - Week Days
    row=[]
    for day in texts.get_weekday_shorts(lang):
...
def process_calendar_selection(lang,update,context):
    """
